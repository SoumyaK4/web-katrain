...
const PATHS: Record<string, string> = {
  ...
  fastFwd: '<path d="m13 19 7-7-7-7M6 19l7-7-7-7"/>',
  ...
  bug:
    '<path d="m8 2 1.88 1.88M14.12 3.88 16 2M9 7.13v-1a3 3 0 0 1 6 0v1M12 20c-3.3 0-6-2.7-6-6v-3a6 6 0 0 1 12 0v3c0 3.3-2.7 6-6 6ZM6 13H2M22 13h-4M6.52 17.35l-3.02 1.74M20.5 19.09l-3.02-1.74M6.52 8.65 3.5 6.91M20.5 6.91l-3.02 1.74"/>',
  play: '<polygon points="6 3 20 12 6 21 6 3"/>',
  undo: '<path d="M3 7v6h6"/><path d="M21 17a9 9 0 0 0-9-9 9 9 0 0 0-6 2.3L3 13"/>',
  flag: '<path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" x2="4" y1="22" y2="15"/>',
  info: '<circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/>',
  sitemap:
    '<rect x="9" y="3" width="6" height="6" rx="1"/><rect x="2" y="15" width="6" height="6" rx="1"/><rect x="16" y="15" width="6" height="6" rx="1"/><path d="M12 9v3M5 15v-1a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v1"/>',
  list:
  ...
  levelUp: '<path d="m18 9-6-6-6 6"/><path d="M12 3v14a4 4 0 0 0 4 4h2"/>',
  layers:
    '<path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z"/><path d="m22 12.5-9.17 4.16a2 2 0 0 1-1.66 0L2 12.5"/>',
  grid:
